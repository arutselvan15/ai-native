# repo-scanner Specification

## Purpose

Read-only CLI that scans a local repository tree and produces a Markdown report of legibility signals (large files, Python complexity heuristics, workshop OpenSpec layout checks) for engineers and AI assistants before making changes.
