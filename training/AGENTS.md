...
| --- | --- | --- | --- |
| **Day 1** | Active | [`day-1/AGENTS.md`](day-1/AGENTS.md) | [`docs/`](../docs/README.md) (repo root) |
...
- **Day 1:** follow [`day-1/AGENTS.md`](day-1/AGENTS.md) only. Plan, design, and verify under repository-root [`docs/`](../docs/README.md); lab code under `day-1/coffee-shop-comparison/`.
...
- **Day 1:** phased plan/design/verify under repository-root `docs/` only (no OpenSpec changes for the warm-up lab). Use a single Python `.venv` at the repository root (see lab README).
